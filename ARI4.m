function Outs = ARI4(index1,c2)
% index1: Nx1 table including partition, c2: Nx1 table including
% ground truth partition. For soft clustering, these could be Nxk.
% tic;
Outs = [];
N = size(index1,2);
% check if they are fuzzy or hard
...
for i = 1:N
    ...
    % nc means the same as E(a+d) in some notation
